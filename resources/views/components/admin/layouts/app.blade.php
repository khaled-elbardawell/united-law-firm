...
<body class="admin-body">
    @php
        ...
        $navItems = [
            ...
            [
                'permission' => 'contact_requests',
                'route' => 'admin.contact-requests.index',
                'active' => 'admin.contact-requests.*',
                'label' => 'طلبات التواصل',
            ...
            [
                ...
                'label' => 'الجهات الموثوقة',
                'icon' => 'fa-solid fa-handshake',
            ],
            [
                'permission' => 'training_courses',
                'route' => 'admin.training-courses.index',
                'active' => 'admin.training-courses.*',
                'label' => 'الدورات التدريبية',
                'icon' => 'fa-solid fa-chalkboard-user',
            ],
            [
                'permission' => 'legal_library',
                'route' => 'admin.legal-library.index',
                'active' => 'admin.legal-library.*',
        ...
        $firstAllowedRoute =
            collect($navItems)->first(fn($item) => $adminUser?->canAccessAdmin($item['permission']))['route'] ?? 'home';
    @endphp
            ...
            <nav class="admin-nav">
                @foreach ($navItems as $item)
                    @if ($adminUser?->canAccessAdmin($item['permission']))
                        <a class="{{ request()->routeIs($item['active']) ? 'active' : '' }}"
