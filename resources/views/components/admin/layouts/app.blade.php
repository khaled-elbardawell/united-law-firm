...
<div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="adminNav">
        ...
        <nav class="admin-nav">
            <a class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">الرئيسية <span><i class="fa-solid fa-house"></i></span></a>
            <a class="{{ request()->routeIs('admin.services.*') ? 'active' : '' }}" href="{{ route('admin.services.index') }}">الخدمات <span><i class="fa-solid fa-scale-balanced"></i></span></a>
            <a class="{{ request()->routeIs('admin.lawyers.*') ? 'active' : '' }}" href="{{ route('admin.lawyers.index') }}">المحامون <span><i class="fa-solid fa-user-tie"></i></span></a>
            <a class="{{ request()->routeIs('admin.faqs.*') ? 'active' : '' }}" href="{{ route('admin.faqs.index') }}">الأسئلة الشائعة <span><i class="fa-solid fa-circle-question"></i></span></a>
            <a class="{{ request()->routeIs('admin.contact-requests.*') ? 'active' : '' }}" href="{{ route('admin.contact-requests.index') }}">طلبات التواصل <span><i class="fa-solid fa-envelope-open-text"></i></span></a>
            <a class="{{ request()->routeIs('admin.consultations.*') ? 'active' : '' }}" href="{{ route('admin.consultations.index') }}">الاستشارات <span><i class="fa-solid fa-calendar-check"></i></span></a>
            <a class="{{ request()->routeIs('admin.users.*') ? 'active' : '' }}" href="{{ route('admin.users.index') }}">المستخدمون <span><i class="fa-solid fa-users-gear"></i></span></a>
            <a class="{{ request()->routeIs('admin.profile.*') ? 'active' : '' }}" href="{{ route('admin.profile.edit') }}">البروفايل <span><i class="fa-solid fa-id-card"></i></span></a>
            <a class="{{ request()->routeIs('admin.seo.*') ? 'active' : '' }}" href="{{ route('admin.seo.index') }}">SEO <span><i class="fa-solid fa-magnifying-glass-chart"></i></span></a>
            <a class="{{ request()->routeIs('admin.settings.*') ? 'active' : '' }}" href="{{ route('admin.settings.edit') }}">إعدادات الموقع <span><i class="fa-solid fa-gear"></i></span></a>
